 ...
 * @author USER
 */
public class vacunaEspecifica extends javax.swing.JFrame {

    /**
     * Creates new form vacunaEspecifica
     */
    public vacunaEspecifica() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite el kit de la vacuna a buscar");

        jLabel2.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 102, 255));
        jLabel2.setText("Kit:");

        txtKit.setText("<Digite el kit a buscar>");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(txtKit, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            if (archivo.exists()) {
                ...
                while ((linea = lector.readLine()) != null) {
                    ...
                    if (txtKit.getText() == null ? vacuna.kit == null : txtKit.getText().equals(vacuna.kit)) {
                        resultadoBusquedaEspecifica vacunaBuscada=new resultadoBusquedaEspecifica(vacuna.kit, vacuna.lote, vacuna.marca, vacuna.efectoAdverso);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vacunaEspecifica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vacunaEspecifica().setVisible(true);
            }
        });
    }
